...
#define NS16550_COM3    ( 2 )   /**< COM3          */
#define NS16550_COM4    ( 3 )   /**< COM4          */
#define NS16550_COM_MIN ( 0 )   /**< COM番号最小値 */
#define NS16550_COM_MAX ( 3 )   /**< COM番号最大値 */
#define NS16550_COM_NUM ( 4 )   /**< COMポート数   */
...
#define NS16550_FCR_RFIFO  ( 0x02 ) /**< FCR[1]: 受信FIFO有効フラグ */
#define NS16550_FCR_TFIFO  ( 0x04 ) /**< FCR[2]: 転送FIFO有効フラグ */
...
/* ストップビット数 */
#define NS16550_LCR_STB_2 ( 0x04 )  /**< ストップビット数(1.5/2ビット) */
#define NS16550_LCR_STB_1 ( 0x00 )  /**< ストップビット数(1ビット)     */
...
/* ディバイザラッチアクセス */
#define NS16550_LCR_DLAB_ON  ( 0x80 )   /**< ディバイザラッチアクセスする   */
#define NS16550_LCR_DLAB_OFF ( 0x00 )   /**< ディバイザラッチアクセスしない */
